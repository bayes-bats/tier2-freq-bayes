...
::: {.callout-note icon="false" title="Questions for the Class"}
-   How does the slope parameter relate to our hypothesis? As a reminder, our hypothesis is: \> *As the population of Black Americans increases (decreases), the level of energy expenditure increases (decreases).* <!-- task-begin -->
    -   (Write your response here): 
<!-- task-end -->
<!-- solution-begin -->
