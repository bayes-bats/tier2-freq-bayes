...
Above, we glossed over how we arrive at a posterior distribution. In addition to the model specification, we must also provide a *prior distribution* for the model's parameters. In a Bayesian analysis the prior represents all of our *prior knowledge* about the problem.
...
The mathematical details of fitting a Bayesian model is outside the scope of this activity. However, the basic "formula" is:
