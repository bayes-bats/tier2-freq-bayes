...
where $m, b, \sigma^2$ are independent.[^autoscale] We will discuss how to set the prior through its parameter values $\mu_m, \mu_b, \sigma_m^2, \sigma_b^2$ later in this activity.

[^autoscale]: Note that $s_y$ is determined based on the standard deviation in the observed data. This is a way of *autoscaling* the prior.
...
ggsave("./prep/CO_priorMA.png", bg = "white")
```
...
ggsave("./prep/CO_priorMN.png", bg = "white")
```
...
ggsave("./prep/CO_priorNH.png", bg = "white")
```
...
ggsave("./prep/FL_priorMA.png", bg = "white")
```
...
ggsave("./prep/FL_priorMN.png", bg = "white")
```
...
ggsave("./prep/FL_priorNH.png", bg = "white")
```
...
ggsave("./prep/USA_priorMA.png", bg = "white")
```
...
ggsave("./prep/USA_priorMN.png", bg = "white")
```
...
ggsave("./prep/USA_priorNH.png", bg = "white")
```
