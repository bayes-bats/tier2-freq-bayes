...
This is the **Bayesian** form of the activity. <!-- solution-end -->
...
-   For the NH-based prior, the posterior predictions do match the data well. The posterior is quite confident in a negative slope, which contradicts our hypothesis. <!-- solution-end -->
...
-   With the prior, we can confidently conclude there is a positive slope <!-- solution-end -->
