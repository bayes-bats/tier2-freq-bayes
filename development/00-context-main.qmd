...
![](./images/bit.ly_olin-bats-pre.png) <!-- Olin survey -->
<!-- ![](./images/bit.ly_du-bats-pre.png) <!-- Replace with Denver survey --> -->
...
You will notice that we have eliminated spaces and other formats so our columns are now easier to work with (using `janitor::clean_names()`). We will focus on a few columns in this dataset:
