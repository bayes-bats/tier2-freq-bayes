...
subtitle: "Exploring the Climate and Economic Justice Screening Tool (CEJS) Data"
format: html
...
[The Climate and Economic Justice Screening Tool](https://screeningtool.geoplatform.gov/en/) (CEJS) is the result of the EO. While the tool established by the Council on Environmental Quality covers a number of burdens (health, transportation, and workforce development, for example), this activity will focus on the sustainability aspects of the tool, including climate change, energy, and legacy pollution burdens on communities. 

Info here on the activity and what's to follow.
...
You will notice that we have eliminated spaces and other formats so our columns are now easier to work with. The next thing we need to do is identify our primary variables of interest for our analyses. 
