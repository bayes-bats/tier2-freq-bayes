...
Let's discuss the critical differences between the two paradigms with the [Critical Differences Reference Guide](https://github.com/bayes-bats/tier2-freq-bayes/blob/main/development/03-simplified-main.qmd).
...
We are going to test our hypothesis and answer our research question using the CEJST dataset. We will compare and discuss the results of our analyses using Frequentist and Bayesian methods to see if they align with our expectations based on the approach we took and assumptions we made. 
