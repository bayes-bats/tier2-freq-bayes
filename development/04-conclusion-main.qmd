...
Some of you received the Frequentist analysis, while others received the Bayesian analysis. With the remainder of class time, separate into groups of 2-3 people and discuss the following:
...
- How might we improve our model based on what we know about **model summaries** and **general inference** for both approaches?
