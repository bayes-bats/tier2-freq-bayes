...
- Creating pre/post-pre survey to assess students' understanding _before_ they begin the activity - will be the same set of Q's as used for the post-pre survey
...
- Students will have the opportunity to response (open-ended) on their understanding of Bayesian/Frequentist assumptions, as well as how they're understanding of statistcal inference has evolved/developed as a result of the activity (if it has)
