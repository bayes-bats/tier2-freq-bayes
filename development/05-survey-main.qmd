...
- Creating pre/post-pre survey to assess students' understanding before they begin the activity - will be the same set of Q's as used for the post-pre survey
- Survey will consist of three primary Q's that align with three LO's
- Students will assess their understanding using a Likert scale + open-ended response to elaborate on their Likert response
- They will do the same thing after the activity, assessing their perceived attitudes both before and after they've completed it
- Students will have the opportunity to respond (open-ended) on their understanding of Bayesian/Frequentist assumptions, as well as how they're understanding of statistical inference has evolved/developed as a result of the activity (if it has)
- S/Z putting together IRB protocol docs for respective universities. Will recruit students and run the activity in March
