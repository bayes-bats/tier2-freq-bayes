...
In the context of the classroom, epistemological frames organize activities in the classroom for students, which in turn affects their knowledge and learning. Our goal is to activate students' epistemological frames by structuring our activity around the 5E Model proposed by @duran20045e. The 5E Model is based on constructivist pedagogies and rests on the notion of inquiry-based teaching, or having students discover information on their own without the direct help of instructors [@duran20045e; @uno1999handbook].

We implement the 5E model in the applied activity, which is captured in the figure below:
