...
## Background
Conveying complex concepts and analytical techniques is one of the most challenging aspects of teaching [@bates2007teaching]. In addition to distilling topics down to make them accessible to all students, instructors are frequently tasked with ensuring that the topics learned in class translate “out in the wild” when students enter their respective professions.  This is true in the social sciences, particularly in the public policy domain, where students are tasked with translating what they know into evidence-based practice that helps shape, execute, and understand policy and its impacts. While the theories underpinning public policy approaches can be challenging to understand, layering the quantitative methods typically needed to test research questions on top of these theories can create added challenges. Too often the methods and theories, alongside the question of usefulness outside of the academy, make it difficult to link analysis and policy practices together [@connelly2021translating]. What is more, students of the social sciences frequently become anxious and tend to avoid quantitative methods unless the methods are contextualized and the connection between their subject and technical approach seems clear [@gunn2017embedding].
