...
We are going to develop a research question and hypotheses and then test them on the cEJST data using methods of statistical inference. Once we have done that, we are going to compare and discuss the output of our methods to see if they align with our expectations. 
