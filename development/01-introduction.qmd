...
1. Create hypotheses that apply to real-world situations and are testable with data and inferential statistics.
   - (Seems broader than what we can accomplish with a paper activity. We're going to give students fixed hypotheses, but let them analyze the data)
2. Analyze your hypotheses using inferential statistics.
   - (Yup!)
3. Evaluate the outcomes of your analyses using what you know about inferential statistics and their respective assumptions.
   - (Can we merge this with 2?)
4. Explain the real-world findings of your analyses, noting how they may differ depending on the approach you used. 
   - (This is great!)
5. Explain the primary differences between frequentist and Bayesian approaches for statistical inference.
   - 
6. Describe the primary statistical assumptions for both the frequentist and Bayesian approaches.
   - (This feels like a more specific description of 5)
   
I took a stab at consolidating and elaborating on the LOs, with some notes for instructors:
