...
* [Critical Differences Reference Guide](https://github.com/bayes-bats/tier2-freq-bayes/blob/main/development/03-one-pager.qmd)
* [Conclusion Discussion](https://github.com/bayes-bats/tier2-freq-bayes/blob/main/development/04-conclusion.qmd)
...
In a meeting (2023-09-26), Mine gave us the following feedback on the activity, which we will incorporate in the next phase of work:
