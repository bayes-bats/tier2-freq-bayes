...
- Created a ["Run of Show"](https://github.com/bayes-bats/tier2-freq-bayes/blob/main/development/run-of-show.md) document that helps instructors facilitate the activity, as well as helped us organize our thinking around how the activity will be run
...
g <- ganttAddTask(g, "Draft conclusion discussion", "2023-09-01", "2023-09-22", done=60)
