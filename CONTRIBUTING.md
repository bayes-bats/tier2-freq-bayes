...
If you encounter any issues or problems in using the materials, we recommend filing an [issue][issues] on the repository. To do so, you must have a [GitHub][github] account. Filing issues is helpful, as it helps us document both past and present problems, and provides us a way to tie specific edits to the materials to individual issues.

Some examples of helpful issues to file are: spelling mistakes, ambiguities in language, or a mismatch between materials.

### Seek Support

To seek support with the materials, we recommend filing an [issue][issues]. This can be particularly helpful for other users; as other potential users may have the same question as you!
